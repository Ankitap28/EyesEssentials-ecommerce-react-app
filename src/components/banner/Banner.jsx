...
const Banner = ({ catRef }) => {
  ...
  return (
    <main className=" flex justify-between items-center py-1 mb-5  relative">
      <section className="max-w-xl mx-auto sm:mx-0  w-full py-2  lg:w-1/3 w-auto">
        <h1 className="text-6xl  sm:text-7xl lg:text-6xl font-semibold  py-3 w-full ">
          {/* Glasses & Lens Sight & Style */}
          Sight & Style Lens &Glasses
        </h1>
